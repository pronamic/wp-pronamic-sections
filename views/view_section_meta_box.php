<?php echo $nonce; ?>
<a href="#" class="button button-primary js-pronamic-sections-add-tab"><?php _e( 'Add tab', 'pronamic-ct-domain' ); ?></a>
...
<div class="pct-tabs-holder js-pronamic-sections-holder" style="padding-top:10px;padding-bottom:10px;">
	...
	<?php for ( $i = 0; $i <= $quantity; $i ++  ) : ?>
		...
		<div class="pct-tab" style="margin-bottom:10px;border:1px solid #ccc;padding:10px;">
			<input type="hidden" name="pct_content[<?php echo $i; ?>][order]" value="<?php echo $i; ?>" class="js-pronamic-sections-order"/>
			<div class="post-tab-title">
				<h3><?php _e( 'Tab Title', 'pronamic-ct-domain' ); ?></h3> 
				<input type="text" name="pct_content[<?php echo $i; ?>][title]" class="widefat" value="<?php echo $title; ?>"/>
			</div>
			...
			<br/>
			<a href="#" class="button button-secondary js-pronamic-section-delete" data-id="<?php echo $i; ?>"><?php _e( 'Delete' ); ?></a>
		</div>
	<?php endfor; ?>
