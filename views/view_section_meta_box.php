	...
	<?php for ( $i = 0; $i <= $quantity; $i ++  ) : ?>
		...
		<div class="pct-tab" style="margin-bottom:10px;border:1px solid #ccc;padding:10px;">
			...
			<div class="post-tab-title">
				<h3><?php _e( 'Section Title', 'pronamic-sections-domain' ); ?></h3> 
...
<a href="#" class="button button-primary js-pronamic-sections-add-tab"><?php _e( 'Add new section', 'pronamic-sections-domain' ); ?></a>
